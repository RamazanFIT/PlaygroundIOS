...
var favoriteBook = Book(title: "Roma", author: "Ramazan", pages: 32, price: 12.23)
print(favoriteBook)
/*:
 ...
 */
struct Laptop{
    var screenSize : Int = 13, repairCount : Int = 0, yearPurchased : Int
    init(repairCount: Int, yearPurchased: Int) {
...
var q1 = Laptop(repairCount: 112, yearPurchased: 21), q2 = Laptop(repairCount: 12, yearPurchased: 32)
q1
print(q2)
/*:
...
var myHeight = Height(centimeters: 193)
