 ...
 */
struct User{
    var user : String, age : Int, height : Double, weight : Double, activityLevel : Int
...
var u1 = User(user: "Rama", age: 18, height: 193, weight: 80, activityLevel: 10)
//:  Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
var ramazan = User(user: "Rama", age: 18, height: 193, weight: 80, activityLevel: 10)
print(ramazan.description())
print(ramazan)
/*:
...
let distanceInMeters2 = Distance(meters: 23)
