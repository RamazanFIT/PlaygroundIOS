 ...
 */
let width = 10, height = 20, area = width * height;print(area)
...
let x = 10
let div = 3
let integerDivisionResult = x / div
...
print(10 / 3) // in interger it will just 3 not 3.3333333(3)
/*:
