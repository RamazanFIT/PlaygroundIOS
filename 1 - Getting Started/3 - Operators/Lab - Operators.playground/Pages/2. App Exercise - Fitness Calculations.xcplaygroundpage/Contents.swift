 ...
 */
let heartRate1 = 61, heartRate2 = 75, heartRate3 = 80
...
let heartRate1D : Double = 61, heartRate2D : Double = 75, heartRate3D : Double = 80
let addedHRD = heartRate3D + heartRate2D + heartRate1D

let averageHRD = addedHRD / 3
print(averageHRD)
//YES it now has the type of Double which can demonstrate to us the exactly result by high precision 
