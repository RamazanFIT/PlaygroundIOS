...
if let area1 = calculateArea(x: 5.0, y: 4.0) {
    print("Area 1: \(area1)") 
} else {
    print("Invalid input")
}

if let area2 = calculateArea(x: -3.0, y: 6.0) {
    print("Area 2: \(area2)")
} else {
    print("Invalid input") 
}
...
if let user = createUser() {
    print("User created with firstName: \(user.firstName), lastName: \(user.lastName), age: \(user.age)")
} else {
    print("Failed to create user. Some input fields are empty.")
}
