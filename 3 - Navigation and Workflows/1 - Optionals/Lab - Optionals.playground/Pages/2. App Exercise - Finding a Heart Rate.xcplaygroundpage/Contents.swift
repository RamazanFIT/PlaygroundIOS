...
let heartRate: Int? = 74


var sumOfHeartRates = 0
var numberOfHeartRates = 0

if let currentHeartRate = heartRate {
    sumOfHeartRates += currentHeartRate
    numberOfHeartRates += 1
}

sumOfHeartRates += oldHR1
sumOfHeartRates += oldHR2
sumOfHeartRates += oldHR3
sumOfHeartRates += oldHR4

numberOfHeartRates += 4


var hrAverage: Int = 0

if numberOfHeartRates > 0 {
    hrAverage = sumOfHeartRates / numberOfHeartRates
}
